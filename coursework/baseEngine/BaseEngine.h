...
public:
	...
	int Initialise( char const* strCaption, int iScreenWidth, int iScreenHeight, char const* szFontName, int iFontSize );
...
public:
	...
	*/
	...
	Font* GetFont( char const* szFontName, int iFontSize )
	{
